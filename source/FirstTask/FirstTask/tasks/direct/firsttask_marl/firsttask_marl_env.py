...
from .firsttask_marl_env_cfg import FirsttaskMarlEnvCfg


class FirsttaskMarlEnv(DirectMARLEnv):
    cfg: FirsttaskMarlEnvCfg

    def __init__(self, cfg: FirsttaskMarlEnvCfg, render_mode: str | None = None, **kwargs):
